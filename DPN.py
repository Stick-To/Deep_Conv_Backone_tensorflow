...
class DPN:
    def __init__(self, config, input_shape, num_classes, weight_decay, keep_prob, data_format):
        ...
        self.block_list_filters = [[i*config['first_dpn_block_filters'][0],
                                   i*config['first_dpn_block_filters'][1],
                                   i*config['first_dpn_block_filters'][2]]
                                   for i in range(1, len(config['dpn_block_list'])+1)
                                   ]
